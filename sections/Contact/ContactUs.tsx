...
function ContactUs() {
  ...
  return (
    <div className="min-h-screen relative bg-background-950 flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8">
      <Toaster />
      <Image
        src={"/contact.jpg"}
        alt={"conatct"}
        width={1280}
        height={720}
        className=" absolute bg-cover w-full h-full z-0"
      ></Image>
